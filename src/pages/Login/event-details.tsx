...
function EventDetails() {
  return (
    <>
      ...
      <div className=" bg-amber-300 w-screen h-screen flex flex-col items-center justify-start">
        ...
        <div className=" fixed left-0 over -full max-w-[380px] h-auto bg-white rounded-2xl relative -top-20 p-6 flex flex-col gap-2">
          ...
          <div className="flex flex-col">
            ...
            <div className=" bg-[#f9f7f7] flex flex-row">
                <div className="itens-start border">
                    <img className="w-20 h-15 rounded-full border border-[#6a00ff]" src={cover} alt="" />
                </div>
                ...
                <div className="border-2 w-full flex flex-col " >
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <div>
                            <span className="text-xs text-gray- font-light">24.06.2026</span>
                        </div>
                    ...
                    <div>
                        <p className="text-xs">Adorei o evento, foi uma experiência incrível! A organização estava impecável!</p>
                    </div>
