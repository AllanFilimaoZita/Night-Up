...
function Profile() {
    return (
        <div className="p-2.5 font-[Gill_Sans,_Calibri,_'Trebuchet_MS',_sans-serif]">

            <header className="flex items-center justify-between pb-6.25">
            ...
            <section className="flex items-center justify-start bg-[rgba(153,153,153,0.041)] rounded-lg border border-[rgba(0,0,0,0.123)] gap-5 p-2.5 pl-6.25">
            ...
            <h4 className="p-2.5 text-sm font-semibold">Dados da conta</h4>
            <section className="bg-[rgba(153,153,153,0.055)] border border-[rgba(0,0,0,0.123)] rounded-lg p-2.5 flex flex-col gap-2.5">

                <div className="flex gap-2.5 items-center transition-colors duration-200 hover:text-[rgb(172,79,79)] group">
                    <CircleUser size={30} />
            ...
            <h4 className="p-2.5 text-sm font-semibold">Suporte (Help & Support)</h4>
            <section className="bg-[rgba(153,153,153,0.055)] border border-[rgba(0,0,0,0.123)] rounded-lg p-2.5 flex flex-col gap-2.5">
